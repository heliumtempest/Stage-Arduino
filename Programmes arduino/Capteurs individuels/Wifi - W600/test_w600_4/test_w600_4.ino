...
const char *TARGET_IP   = "\"145.14.145.48\""; // This is the IP address for AdafruitIO
...
// Je tente une fonction à part, sait-on jamais
// Comme d'habitude, marche une seule fois, pas les autres
void post_data(int socket, char data[]){
...
{
  char data[] = "coucou\n";
  post_data(socket, value); //changer le paramètre
  //post_data(value);
  delay(15000);    
}
